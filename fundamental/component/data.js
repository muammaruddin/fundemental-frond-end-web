...
function createNoteElement(note) {
  ...
  deleteButton.addEventListener('click', () => {
    deleteNote(note.id); // Panggil fungsi deleteNote dengan ID catatan sebagai parameter
  });
